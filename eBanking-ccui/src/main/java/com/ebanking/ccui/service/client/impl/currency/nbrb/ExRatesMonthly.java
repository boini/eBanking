...
public class ExRatesMonthly  implements java.io.Serializable {
    private java.util.Calendar onDate;

    public ExRatesMonthly() {
    }
    ...
    /**
     * Gets the onDate value for this ExRatesMonthly.
     * 
     * @return onDate
     */
    ...
    /**
     * Sets the onDate value for this ExRatesMonthly.
     * 
     * @param onDate
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExRatesMonthly)) return false;
        ExRatesMonthly other = (ExRatesMonthly) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExRatesMonthly.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.nbrb.by/", ">ExRatesMonthly"));
